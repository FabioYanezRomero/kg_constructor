...
**Key Files:**
- `kgb/builder/augmentation.py` - Strategy Protocol, Registry, implementations
...
> See existing `augment_connectivity` command in `kgb/__main__.py` for complete reference.
