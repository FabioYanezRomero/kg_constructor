...
This skill guides you through adding a new augmentation strategy to the `kgb/builder/` module.
...
**Key Files:**
- [augmentation.py](file:///app/kgb/builder/augmentation.py) - Strategy Protocol, Registry, and implementations.
- [__init__.py](file:///app/kgb/builder/__init__.py) - Public exports.
...
Add your strategy function to `kgb/builder/augmentation.py`:
...
Update `kgb/__main__.py` to expose your strategy:
...
> [!TIP]
> For a complete reference, see the existing `augment_connectivity` command in [__main__.py](file:///app/kgb/__main__.py).
